                    ...
                    <div class="card-body">
                        ...
                        <div class="auth-brand text-center text-lg-left">
                            <a href="{{route('admin.login')}}" class="logo-dark">
                                <span><img src="../assets/images/logo.jpg" class="img-responsive" alt="Logo" height="90"></span>
                            </a>
                        ...
                        @csrf
                            ...
                            <div class="form-group mb-3">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="customCheckcolor5"name="remember" {{ old('remember')
                                    ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="customCheckcolor5">{{ __('Remember Me') }}</label>
                                </div>
                            </div>
